const applicationState = {
    ...
    clowns: [], // added this as a place for fetchClowns to store its data
    completions: []
}
...
export const fetchRequests = () => {
    return fetch(`${API}/requests`) // returns a promise to tell you when it returns the information from the website
        ...
        .then(
            (partyRequests) => { // returns the data converted from a string into an array
...
// row9 instructions had fetchRequests, changed it to fetchClowns
